...
declare -a compilers=("clang-7.1.0" "clang-8.0.1" "clang-9.0.1" "clang-10.0.1" "clang-11.0.1" "clang-12.0.1" "clang-13.0.1" "clang-14.0.0" "clang-15.0.0" "clang-16.0.0")
...
cp -a /app/compiler-explorer/etc/config/c++.enzyme.properties /tmp/ce/
cp -a /app/compiler-explorer/etc/config/c.enzyme.properties /tmp/ce/
cp -a /app/compiler-explorer/etc/config/llvm.enzyme.properties /tmp/ce/


for branch in ${branches[@]}; do

	setProperty "group.clang-enzyme-$branch.compilers" "clang7-enzyme-$branch:clang8-enzyme-$branch:clang9-enzyme-$branch:clang10-enzyme-$branch:clang11-enzyme-$branch:clang12-enzyme-$branch:clang13-enzyme-$branch:clang14-enzyme-$branch:clang15-enzyme-$branch:clang16-enzyme-$branch" "/tmp/ce/c++.enzyme.properties"
	setProperty "group.clang-enzyme-$branch.compilers" "cclang7-enzyme-$branch:cclang8-enzyme-$branch:cclang9-enzyme-$branch:cclang10-enzyme-$branch:cclang11-enzyme-$branch:cclang12-enzyme-$branch:cclang13-enzyme-$branch:cclang14-enzyme-$branch:cclang15-enzyme-$branch:cclang16-enzyme-$branch" "/tmp/ce/c.enzyme.properties"
    setProperty "group.clang-enzyme-$branch.compilers" "irclang7-enzyme-$branch:irclang8-enzyme-$branch:irclang9-enzyme-$branch:irclang10-enzyme-$branch:irclang11-enzyme-$branch:irclang12-enzyme-$branch:irclang13-enzyme-$branch:irclang14-enzyme-$branch:irclang15-enzyme-$branch:irclang16-enzyme-$branch" "/tmp/ce/llvm.enzyme.properties"
	setProperty "group.opt-enzyme-$branch.compilers" "opt7-enzyme-$branch:opt8-enzyme-$branch:opt9-enzyme-$branch:opt10-enzyme-$branch:opt11-enzyme-$branch:opt12-enzyme-$branch:opt13-enzyme-$branch:opt14-enzyme-$branch:opt15-enzyme-$branch:opt16-enzyme-$branch" "/tmp/ce/llvm.enzyme.properties"
...
cp -a /tmp/ce/c++.enzyme.properties /app/compiler-explorer/etc/config/
cp -a /tmp/ce/c.enzyme.properties /app/compiler-explorer/etc/config/
cp -a /tmp/ce/llvm.enzyme.properties /app/compiler-explorer/etc/config/
