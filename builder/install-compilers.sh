...
/app/infra/bin/ce_install --filter-match-any install "compilers/c++/clang 15.0.0" "compilers/c++/clang 16.0.0" "compilers/c++/clang 17.0.1" "compilers/c++/clang 18.1.0" "compilers/c++/clang 19.1.0" "compilers/c++/clang 20.1.0" "compilers/c++/mlir 16.0.0" "compilers/julia 1.10.0"
