...
/opt/compiler-explorer/julia-1.10.0/bin/julia -e 'using Pkg; Pkg.add(["Enzyme", "Reactant"])'
/opt/compiler-explorer/julia-1.11.2/bin/julia -e 'using Pkg; Pkg.add(["Enzyme", "Reactant"])'
